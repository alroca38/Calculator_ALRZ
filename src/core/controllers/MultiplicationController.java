...
public class MultiplicationController {
    public static Response performMultiplication(String number1, String number2, String[] result) {
        try {
            ...
            Operation operationToPerfom = new Multiplication();
            ...
            PrintableOperation operation = new PrintableOperation(number1Double, number2Double, "x", resultDouble);
