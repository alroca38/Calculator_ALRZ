...
import core.models.operations.Potentiation;

public class PotentiationController {
    public static Response performPotentiation(String number1, String number2, String[] result) {
        try {
            ...
            Operation operationToPerfom = new Potentiation();
