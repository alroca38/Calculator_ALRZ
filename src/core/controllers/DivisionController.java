...
public class DivisionController {
    ...
    public static Response performDivision(String number1, String number2, String[] result) {
        try {
            ...
            if (number2Double == 0) {
                return new Response("Denominator cannot be zero", Status.BAD_REQUEST);
            }
            ...
            Operation operationToPerfom = new Division();
